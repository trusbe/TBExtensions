...
public extension UIImage {
    ...
    ///生成二维码
    class func generateQRCode(text: String, width: CGFloat, fillImage: UIImage? = nil,  color: UIColor? = nil) -> UIImage? {
        //给滤镜设置内容
    ...
    ///生成条形码
    class func generateCode128(text:String, size:CGSize, color:UIColor? = nil ) -> UIImage? {
        //给滤镜设置内容
        guard let data = text.data(using: .utf8) else {
            return nil
        }
