#
#  Be sure to run `pod spec lint TBExtensions.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "TrusBe"
  # s.authors            = { "TrusBe" => "trusbe@xbeacon.net" }
  # s.social_media_url   = "http://twitter.com/TrusBe"
